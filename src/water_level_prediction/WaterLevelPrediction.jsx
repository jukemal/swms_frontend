...
const Chart = ({ data_real, data_predicted }) => {
    let series = []
...
const DataTable = ({ rows_real, rows_predicted }) => {
    const classes = useStyles();
...
const WaterLevelPrediction = (props) => {
    ...
    return (
        <Card>
            <AdminTitle title="Water Level Prediction" />
            <CardContent>
                <main className={classes.content}>
                    ...
                    <Container maxWidth="lg" className={classes.container}>
                        <Grid container spacing={3}>
                            <Grid item xs={12}>
                                <Paper >
                                    <Chart data_real={data.real} data_predicted={data.predicted} />
                                </Paper>
                            </Grid>
                            <Grid item xs={12}>
                                <Paper className={classes.paper}>
                                    <DataTable rows_real={data.real} rows_predicted={data.predicted} />
                                </Paper>
                            </Grid>
                        </Grid>
                    </Container>
